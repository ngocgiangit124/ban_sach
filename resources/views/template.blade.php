            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="/admin/">
                    <div class="brand-logo">
                        <img class="img-responsive" src="/front/images/logo.png" width="100" alt="App Logo">
                    </div>
        ...
        <div class="aside-inner">
            <nav class="sidebar" data-sidebar-anyclick-close="">
                ...
                <ul class="nav">
                    ...
                    <li class=" ">
                        <a href="#dashboard" class="" title="Dashboard" data-toggle="collapse" aria-expanded="true">
                            <div class="pull-right label label-info">3</div>
                            <em class="icon-speedometer"></em>
                            <span data-localize="sidebar.nav.DASHBOARD">Mục sản phẩm</span>
                        </a>
                        <ul class="nav sidebar-subnav collapse in" id="dashboard" aria-expanded="true">
                    ...
                    <li class="nav-heading ">
                        <span data-localize="sidebar.heading.COMPONENTS">Giới Thiệu</span>
                    </li>
                    <li class=" ">
                        <a href="/admin/gioithieu" title="Widgets">
                            <div class="pull-right label label-success">10</div>
                            <em class="icon-layers"></em>
                            <span data-localize="sidebar.nav.WIDGETS">Danh sách</span>
                        </a>
                    ...
                    <li class="nav-heading ">
                        <span data-localize="sidebar.heading.COMPONENTS">Tin Tức</span>
                    </li>
                    <li class=" ">
                        <a href="/admin/tintuc" title="Widgets">
                            <div class="pull-right label label-success">10</div>
                            <em class="icon-layers"></em>
                            <span data-localize="sidebar.nav.WIDGETS">Danh sách</span>
                        </a>
