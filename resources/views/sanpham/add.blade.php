...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <form method="post" id="form-spec" class="form-spec" action="/admin/sanpham" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="ChatLieu" required >
                            </div>
                            <div class="form-group">
                                <label class="control-label">Kích Thước</label>
                                <input class="form-control" type="text" name="KichThuoc" required >
                            </div>
                            <div class="form-group">
                                <label class="control-label">Màu Sắc</label>
                                <input class="form-control" type="text" name="MauSac" required >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="GiaoHang" required >
                            </div>
                            <div class="form-group">
                                <label class="control-label">Nhà Sản Xuất</label>
                                <input class="form-control" type="text" name="NhaSanXuat" required >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-control wysiwyg mt-lg input-show-spec" style="overflow:scroll; height:300px;max-height:500px;"></div>
                                    <input type="hidden" class="input-hidden-spec" name="Xem">
                                </div>
                            </div>
