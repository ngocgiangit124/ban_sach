...
@section('content')
    <div class="content-heading">Danh mục Slides
        <a href="/admin/tintuc/create" class="mb-sm btn btn-info pull-right">Tạo mới</a>
    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="datatable2">
                                ...
                                <tr>
                                    ...
                                    <th style="width:5%;display:block;">Delete</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($tintucs as $tintuc)
                                <tr class="gradeX" id="{{$tintuc['Id']}}">
                                    <td>{{$tintuc['Id']}}</td>
                                    <td>{{$tintuc['Name']}}</td>
                                    <td><img src="{{$tintuc['Photos']['Small']}}" alt=""></td>
                                    <td>{!! substr($tintuc['Description'],0,100) !!}</td>
                                    <td><a href="/admin/tintuc/{{$tintuc['Id']}}/edit">Edit</a></td>
