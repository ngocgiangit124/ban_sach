...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <form id="form-spec" method="post" action="/admin/tintuc" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <!-- START panel-->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="panel-title">Tạo mới tin tức</div>
                        </div>
                            ...
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-control wysiwyg mt-lg input-show-spec" style="overflow:scroll; height:500px;max-height:500px;">Type something ...</div>
                                        <input type="hidden" class="input-hidden-spec" name="Description">
                                    </div>
                                </div>
                            </fieldset>
                            <div class="form-group">
                                <label class="control-label">Anh Hiển thị</label>
