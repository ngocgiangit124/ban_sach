...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <form id="form-spec" method="post" action="/admin/tintuc/{{$tintuc['Id']}}" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="Name" value="{{$tintuc['Name']}}" required>
                            </div>
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="hidden" class="input-hidden-spec" name="Description" value="{{$tintuc['Description']}}">
                                    </div>
                                </div>
                            </fieldset>
                            <div class="form-group">
                            ...
                            <div class="">
                                ...
                                <img src="{{$tintuc['Photos']['Small']}}" alt="">
                            </div>
                        </div>
